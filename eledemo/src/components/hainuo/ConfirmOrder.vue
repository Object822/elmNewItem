          ...
          <div class="address">
            ...
            <div class="title" v-else>
              <div v-if="content">
                ...
                <div class="title-bot">
                  <span
                    :style="{backgroundColor:setbagcolor(content[index])}"
                    style=" border-radius:0.03rem;  color: white"
                  >{{content&&content[index].tag}}</span>
              ...
              <div v-else>
                ...
                <div class="title-bot">
                  <span
                    :style="{backgroundColor:setbagcolor(addData[0])}"
                    style=" border-radius:0.03rem;  color: white"
                  >{{addData&&addData[0].tag}}</span>
